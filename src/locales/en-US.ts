export default {
  ...
  home: {
    ...
    theme: 'Theme',
    language: 'Language',
    selectLanguage: 'Plaease Select Language',
    capture: 'Capture',
    search: 'Search',
  },
  file: {
    ...
    storage: "Storage",
    noStorageSpace: "No Storage Space",
    list: "List",
    progressBar: "Progress bar",
    transfer: "Transfer",
    noBoundDomain: "No bound domain",
    upload: "Upload",
    download: "Download",
    delete: "Delete",
    none: "None",
    file: "File",
    noBucketCurrentlySelected: "No bucket is currently selected",
    noFilesInTheCurrentBucket: "no files in the current bucket",
    total: "Total",
    transportListNotFound: "Transport list not found",
    operation: "Operation",
    notFound: "Not Found",
    profile: "Profile",
    basic: "Basic",
    ...
    software: "Software",
    defaultUploadPath: "Default upload path",
    defaultUploadPrefix: "Default upload prefix",
